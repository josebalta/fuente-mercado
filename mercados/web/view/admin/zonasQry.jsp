...
<html>
    <head>
        ...
        <script src="js/zonasQry.js" type="text/javascript"></script>
    </head>
    ...
    <body>
        ...
        <div class="ui-layout-center" style="padding-top: 30px">
            <table class="parainfo" style="margin: auto;width: 500px">
                <caption>
                    <div style="float: left">Lista de Zonas</div>
                    <div style="float: right">
                        <select id="zonasCbo" class="parainfo" onchange="zonasQry();"></select>
                    </div>
                ...
                <thead>
                    <tr>
                        <td>Zona</td>
                        <th class="crud">
                            <a class="ins" href="#" onclick="zonasIns();"
                               title="Nuevo Registro">
                                <span></span></a>
                        </th>
                        <th class="crud">
                            <a class="del" href="#" onclick="zonasDel();"
                               title="Retirar Registros">
                                <span></span></a>
                        </th>
                        <th class="crud">
                            <a class="upd" href="#" onclick="zonasUpd();"
                               title="Actualizar Registro">
                                <span></span></a>
                        </th>
                    </tr>
                </thead>
                <tbody id="zonasQry"></tbody>
            </table>
        </div>
