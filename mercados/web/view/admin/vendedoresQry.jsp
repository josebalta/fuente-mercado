...
<html>
    <head>
        ...
        <script src="js/vendedoresQry.js" type="text/javascript"></script>
    </head>
    ...
    <body>
        ...
        <div class="ui-layout-center" style="padding-top: 30px">
            <table class="parainfo" style="margin: auto;width: 500px">
                <caption>
                    <div style="float: left">Lista de Vendedores</div>
                    <div style="float: right">
                        <select id="vendedoresCbo" class="parainfo" onchange="vendedoresQry();"></select>
                    </div>
                ...
                <thead>
                    <tr>
                        ...
                        <td>Estado</td>
                        <th class="crud">
                            <a class="ins" href="#" onclick="vendedoresIns();"
                               title="Nuevo Registro">
                                <span></span></a>
                        </th>
                        <th class="crud">
                            <a class="del" href="#" onclick="vendedoresDel();"
                               title="Retirar Registros">
                                <span></span></a>
                        </th>
                        <th class="crud">
                            <a class="upd" href="#" onclick="vendedoresUpd();"
                               title="Actualizar Registro">
                                <span></span></a>
                        </th>
                    </tr>
                </thead>
                <tbody id="vendedoresQry"></tbody>
            </table>
        </div>
