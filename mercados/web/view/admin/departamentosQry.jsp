...
<html>
    <head>
        ...
        <script src="js/departamentosQry.js" type="text/javascript"></script>
    </head>
    ...
    <body>
        ...
        <div class="ui-layout-center" style="padding-top: 30px">
            <table class="parainfo" style="margin: auto;width: 500px">
                <caption>
                    <div style="float: left">Lista de Departamentos</div>
                    <div style="float: right">
                        <select id="departamentosCbo" class="parainfo" onchange="departamentosQry();"></select>
                    </div>
                ...
                <thead>
                    <tr>
                        <td>Departamento</td>
                        <th class="crud">
                            <a class="ins" href="#" onclick="departamentosIns();"
                               title="Nuevo Registro">
                                <span></span></a>
                        </th>
                        <th class="crud">
                            <a class="del" href="#" onclick="departamentosDel();"
                               title="Retirar Registros">
                                <span></span></a>
                        </th>
                        <th class="crud">
                            <a class="upd" href="#" onclick="departamentosUpd();"
                               title="Actualizar Registro">
                                <span></span></a>
                        </th>
                    </tr>
                </thead>
                <tbody id="departamentosQry"></tbody>
            </table>
        </div>
