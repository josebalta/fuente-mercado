...
<html>
    <head>
        ...
        <script src="js/usuariosQry.js" type="text/javascript"></script>
    </head>
    ...
    <body>
        ...
        <div class="ui-layout-center" style="padding-top: 30px">
            <table class="parainfo" style="margin: auto;width: 500px">
                <caption>
                    <div style="float: left">Lista de Usuarios</div>
                    <div style="float: right">
                        <select id="usuariosCbo" class="parainfo" onchange="usuariosQry();"></select>
                    </div>
                ...
                <thead>
                    <tr>
                        ...
                        <td>Rol</td>
                        <th class="crud">
                            <a class="ins" href="#" onclick="usuariosIns();"
                               title="Nuevo Registro">
                                <span></span></a>
                        </th>
                        <th class="crud">
                            <a class="del" href="#" onclick="usuariosDel();"
                               title="Retirar Registros">
                                <span></span></a>
                        </th>
                        <th class="crud">
                            <a class="upd" href="#" onclick="usuariosUpd();"
                               title="Actualizar Registro">
                                <span></span></a>
                        </th>
                    </tr>
                </thead>
                <tbody id="usuariosQry"></tbody>
            </table>
        </div>
                ...
                <form class="parainfo">
                    <table>
                        ...
                        <tr>
                            <td>Rol</td>
                            <td>
                                <select id="idrol_ins" style="width: 310px"></select>
                            </td>
                        </tr>
                        <tr>
                            <td>Password</td>
                            <td>
                                <input type="password" id="clave_ins" maxlength="20" style="width: 300px"/>
                            </td>
                        </tr>
                    </table>
                </form>
                ...
                <form class="parainfo">
                    <table>
                        ...
                        <tr>
                            <td>Rol</td>
                            <td>
                                <select id="idrol_upd" style="width: 310px"></select>
                            </td>
                        </tr>
                    </table>
                </form>
